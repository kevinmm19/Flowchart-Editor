...
--------------------------------------------------
Subrutinas	-> Rectángulo con doble borde
--------------------------------------------------
Entrada/Salida	-> Romboide
--------------------------------------------------
Paso de decisión 	-> Rombo
--------------------------------------------------
Conjunción	-> Caja negra
--------------------------------------------------
Conectores etiquetados	-> Circulo 
--------------------------------------------------
Concurrencia	-> Doble línea transversal con cualquier cantidad de flechas de entrada y salida
--------------------------------------------------
